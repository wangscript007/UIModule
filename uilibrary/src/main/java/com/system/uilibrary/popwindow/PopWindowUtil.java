...
public class PopWindowUtil {
    ...
    public PopupWindow createListPopWindow(Context context, View mView , String[] data, final OnPopWindowListener listener){
        ...
        final PopupWindow windowUtil = makeWrapContentPopupWindow( mView, view);
    ...
    // TODO: 2018/12/26 0026  传入view的id无法获取
    public PopupWindow createListPopWindow(Context context, View mView , int layout, String[] data, final OnPopWindowListener listener){
       ...
       /// LinearLayout linearLayout=view.findViewById(R.id.root);
        ...
        final PopupWindow windowUtil = makeMatchParentPopupWindow( mView, view,dm.heightPixels);
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                String item = (String) adapter.getItem(position);
