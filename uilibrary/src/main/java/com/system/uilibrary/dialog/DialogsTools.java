...
public class DialogsTools {
    ...
    public  void createPhotoDialog(@Nullable String titleStr, final PhotoListener listener) {
        final Dialog loadingDialog = new Dialog(context, R.style.MyDialogStyle);
        LayoutInflater inflater = LayoutInflater.from(context);
        // 得到加载view
    ...
    public void DanXuanDialog(String[] datas, int defaultid, String title, final OnStringCallBack callBack){
    ...
    public void CreateCustomEditDialog(String title, String btn, final onButtonClickListener listener){
        Dialog loadingDialog = new Dialog(context, R.style.MyDialogStyle);
        LayoutInflater inflater = LayoutInflater.from(context);
        // 得到加载view
        ...
        final EditText content=v.findViewById(R.id.ed_content);
